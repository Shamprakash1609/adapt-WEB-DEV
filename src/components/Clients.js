...
import technoincubator from '../images/clients/technoincubator.png';
import sec from '../images/clients/sec.png';
import sit from '../images/clients/sit.png';
            ...
            <section data-aos="fade-up">
                ...
                <div className="p-16" data-aos="fade-in" data-aos-delay="600">
                    ...
                    <div style={clientImage} className="overflow-hidden p-3 flex justify-center transition-all ease-in-out opacity-50 hover:opacity-100">
                            <img src={sec} alt="client" />                            
                        </div>

                        <div style={clientImage} className="overflow-hidden p-3 flex justify-center transition-all ease-in-out opacity-50 hover:opacity-100">
                            <img src={technoincubator} alt="client" />                            
                        </div> 

                        <div style={clientImage} className="overflow-hidden p-3 flex justify-center transition-all ease-in-out opacity-50 hover:opacity-100">
                            <img src={sit} alt="client" />                            
                        </div>
