                ...
                <div className="m-auto overflow-hidden mx-4 mt-8 lg:mt-4 p-2 md:p-12 h-5/6" data-aos="zoom-in">
                    ...
                    <div id='hero' className="flex flex-col lg:flex-row py-8 justify-between text-center lg:text-left">
                        <div className="lg:w-1/2 flex flex-col justify-center" data-aos="zoom-in" data-aos-delay="200">
                            ...
                            Welcome to Adapt - Revolutionizing the Future with tBot                            </h1>
                            <div className="text-xl font-semibold tracking-tight mb-5 text-gray-500">At Adapt, we deliver the future of automation with Tbot—a fast, reliable solution to optimize your business operations with precision.</div>
                        ...
                        <div className="flex lg:justify-end w-full lg:w-1/2" data-aos="fade-up" data-aos-delay="700">
                            <img alt="card img" className="rounded-lg float-right duration-1000  h-86 hero-img" src={heroImg} />
                        </div>
                    </div>
                </div>
            </div>
