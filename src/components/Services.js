...
const Services = () => {
    ...
    return (
        <div id="services" className="bg-gray-100 py-12 s" >
            <section data-aos="zoom-in-down">
                    ...
                    <div className="px-12" data-aos="fade-down" data-aos-delay="600">
                        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-blue-700 hover:text-white rounded-lg shadow-2xl p-3 group">
                                <div className="m-2 text-justify text-sm">
                                <img alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img} />
                                    <h2 className="font-semibold my-4 text-2xl text-center">Telepresence Solutions</h2>
                                    <p className="text-md font-medium">
                                    Our tbot enables seamless remote communication and collaboration, allowing users to virtually navigate spaces and interact in real-time from anywhere.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-blue-700 hover:text-white rounded-lg shadow-2xl p-3 group">
                                <div className="m-2 text-justify text-sm">
                                    ...
                                    <h2 className="font-semibold my-4 text-2xl text-center ">AI-Powered Automation</h2>
                                    <p className="text-md font-medium">
                                    Integrate AI-driven automation with tbot to enhance efficiency, enabling intelligent task management and remote control.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-blue-700 hover:text-white rounded-lg shadow-2xl p-3 group">
                                ...
                                <img alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img4} />
                                    <h2 className="font-semibold my-4 text-2xl text-center ">Technical Support & Maintenance</h2>
                                    <p className="text-md font-medium">
                                    Ensure smooth operation of your tbot with our comprehensive support, regular updates, and maintenance services.
                                    </p>
                                </div>
                            </div>                    
                        </div>
